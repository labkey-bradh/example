...
package org.labkey.test.components.example;
 ...
 */
public class exampleWebPart extends BodyWebPart<exampleWebPart.ElementCache>
{
    public exampleWebPart(WebDriver driver)
    {
        this(driver, 0);
    }
